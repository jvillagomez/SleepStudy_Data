...
#     print(epochStartTimes[0], epochStartTimes[-1])
    ...
    currentRecord["epochStartTimes"] = epochStartTimes
    currentRecord["epochStages"] = stages
  ...
  for stage in stageData:
    for demo in demoData:
      if stage["subjectID"] == demo["subjectID"]:
        ...
        filePath = "C:\\mednick\\lsd\\json\\nights\\"+subjectID+"_v"+str(visitID)+".json"
